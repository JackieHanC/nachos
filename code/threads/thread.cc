...
Thread::Thread(char* threadName)
{
    ...
    //use function(assign_t_id()) to assign t_id
    this->t_id = Thread::assign_t_id();
    t_ids[t_id] = 1;
    tid_pointer[this->t_id] = this;
...
static Thread* 
Thread::getInstance(char * threadName, int priority)
    //, int timeNeed)
{
    int tid = Thread::assign_t_id();
...
//Thread::assign_t_id 
// no assignment 
// this function is used to assign t_id to thread
// which is unique 
